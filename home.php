            ...
            <div class="col-md-4 offset-md-4">
                <form name="login-form" method="GET" action="home.php" id="myForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="date" placeholder="Enter Date of Arrival">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="phone" class="form-control" name="phone" placeholder="Enter Contact Number">
                      </div>
                      <div class="form-group">
